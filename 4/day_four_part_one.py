...
def main():
    ...
    with open('input.txt', 'r', encoding="utf8") as input_file:
        ...
        for line in lines:
            ...
            if set_assignment_one.issubset(set_assignment_two) or set_assignment_two.issubset(set_assignment_one):
                print(f'{set_assignment_one} and {set_assignment_two} overlap!')
